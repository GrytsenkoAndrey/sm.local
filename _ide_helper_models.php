 ...
 * @property string|null $subtitle Lead text
 * @property string|null $main_img Main article image
 * @property string $content Article main content
 * @property string $status Article status: draft, published
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Article whereMainImg($value)
